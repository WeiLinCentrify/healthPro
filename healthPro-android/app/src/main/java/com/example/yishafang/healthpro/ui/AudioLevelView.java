package com.example.yishafang.healthpro.ui;
...
public class AudioLevelView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(com.example.yishafang.healthpro.R.color.black_grey));
        mPaintGradient.setStyle(Style.FILL);
        mPaintGradient.setColor(getResources().getColor(com.example.yishafang.healthpro.R.color.init_gradient));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPaintGradient.setShader(new RadialGradient(w / 2, h / 2, h / 2,
                getResources().getColor(com.example.yishafang.healthpro.R.color.color0_gradient), getResources().getColor(com.example.yishafang.healthpro.R.color.color1_gradient), TileMode.CLAMP));
