...
public class SubscriberControlFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.example.yishafang.healthpro.R.layout.layout_fragment_sub_control,
                container, false);

        mSubContainer = (RelativeLayout) openTokActivity
                .findViewById(com.example.yishafang.healthpro.R.id.fragment_sub_container);

        showSubscriberWidget(mSubscriberWidgetVisible, false);

        mSubscriberMute = (ImageButton) rootView
                .findViewById(com.example.yishafang.healthpro.R.id.muteSubscriber);
        mSubscriberMute.setOnClickListener(this);

        mSubscriberName = (TextView) rootView.findViewById(com.example.yishafang.healthpro.R.id.subscriberName);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.example.yishafang.healthpro.R.id.muteSubscriber:
                muteSubscriber();
                break;
        }
    }
    ...
    public void muteSubscriber() {
        ...
        mSubscriberMute.setImageResource(openTokActivity.getmSubscriber()
                .getSubscribeToAudio() ? com.example.yishafang.healthpro.R.drawable.unmute_sub
                : com.example.yishafang.healthpro.R.drawable.mute_sub);
    }
